                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="<?= Yii::$app->request->baseUrl.'/user/'.Yii::$app->user->identity->image ?>" class="img-circle"
                                 alt="User Image"/>

                            <p>
                                <?= Yii::$app->user->isGuest ? null : Yii::$app->user->identity->fullname;?>
                                <small><?= Yii::$app->user->isGuest ? null : Yii::$app->user->identity->post;?></small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
                        <li class="user-footer">
                            <div class="pull-left">                                
                                <?= Html::a('ข้อมูลส่วนตัว',['user/profile'],['class'=>'btn btn-default btn-flat'])?>
                            </div>
